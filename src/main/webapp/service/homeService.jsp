...
<body>
	...
	<div class="d-flex flex-column mt-5 align-items-center">
		<div class="d-flex flex-row align-items-center justify-content-around mt-5 pt-5">
			<img class="col-7 rounded-4" style="width: 26rem; height: auto;" alt="Home Cleaning" src="../images/home-cleaning-home-page.jpeg">
			<div class="d-flex flex-column col-5 align-items-center">
				<p class="fs-5 my-5">Keep your home pristine and inviting with our comprehensive cleaning services. From dusting and mopping to kitchen and bathroom cleaning, we ensure every corner shines.</p>
		...
		<div class="d-flex flex-column align-items-center mt-5 w-100" id="detail-services" style="height: 70vh;">
			...
			<div class="d-flex flex-column w-100 justify-content-center">
				<div class="d-flex flex-column flex-wrap w-100 my-3 align-items-center">
					<div class="accordion mx-5 row w-75 my-0" id="homeServiceAccordion">
					<%
			        ...
			        %>
			        	<div class="accordion-item col-12 p-0">
						    ...
						    <div id="collapse-<%=count %>" class="accordion-collapse collapse p-4" data-bs-parent="#homeServiceAccordion">
