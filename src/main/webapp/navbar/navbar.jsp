                    ...
                    <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu services">
                                <li><a class="dropdown-item" href="../service/homeCleaning.jsp">Home Cleaning</a></li>
                                <li><a class="dropdown-item" href="../service/officeCleaning.jsp">Office Cleaning</a></li>
                                <li><a class="dropdown-item" href="#">Deep Cleaning</a></li>
                                <li><a class="dropdown-item" href="../service/airconService.jsp">Aircon Service</a></li>
                                <li><a class="dropdown-item" href="#">Move in/Move out</a></li>
                            </ul>
                        </li>
